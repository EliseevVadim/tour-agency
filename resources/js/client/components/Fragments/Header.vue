<template>
    <section class="hero-section" :class="{'w-100 position-fixed':isShop}" :style="isShop ? { zIndex: 10 } : {}">
        <nav class="hero-top-bar container-xl d-flex justify-content-between align-items-center">
            ...
            <div v-if="!isShop && !isPageHotels" class="hero-top-bar-right d-block">
                <a class="phone-plate btn btn-cta py-2 align-content-center" :class="{'bg-transparent': !isMain}"
            ...
            <div v-if="isPageHotels" class="social-icons icons-flex">
            ...
            <div class="collapse navbar-collapse mobile-menu" id="mobileMenuContent">
                <nav class="nav w-100 d-block">
                    ...
                    <div class="social-icons-menu d-flex flex-fill gap-2 mt-4">
                        ...
                        <a v-if="false" href="https://instagram.com/put_club" target="_blank"
...
export default {
 ...
 @media (max-width: 576px) {
     ...
     .social-icons.icons-flex .social {
         height: 25px;
         display: flex;
         align-items: center;
         justify-content: center;
     ...
     .social-icons.icons-flex .social svg {
         width: 22px;
         height: 22px;
     }
 }
