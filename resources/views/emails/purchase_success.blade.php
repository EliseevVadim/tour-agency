                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="padding-bottom: 20px; text-align: center;">
                                    <p class="content-text" style="font-size: 20px; font-weight: bold; line-height: 1.2; margin-bottom: 0;
                                    margin-top: 0;">
                                        @if($courseName === 'opti')
                                            Прекрасные новости!
                                        @elseif($courseName === 'mini')
                                            Хорошие новости!
                                        @endif
                                    </p>
                                </td>
                                ...
                                <td>
                                    @if($courseName === 'opti')
                                        <p class="content-text">
                                            Для того чтобы пройти курс максимально эффективно и получить ответы на все
                                            вопросы, в <b>пакете "ОПТИ"</b> доступна группа для общения с кураторами и
                                            наставниками проекта.
                                        </p>
                                    @elseif($courseName === 'mini')
                                        <p class="content-text">
                                            Для того чтобы пройти курс максимально эффективно в <b>пакете "МИНИ",</b>
                                            вам доступна группа с новостями и обновлениями от наставников проекта.
                                        </p>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="padding-bottom: 25px;">
                                    @if($courseName === 'opti')
                                        <p class="content-text">
                                            <b>Обязательно вступите в группу,</b> чтобы не упустить важные моменты и
                                            получать постоянную поддержку. Мы ждем вас!
                                        </p>
                                    @elseif($courseName === 'mini')
                                        <p class="content-text">
                                            <b>Не забудьте вступить в группу,</b> чтобы не упустить важные новости. Мы
                                            ждем вас!
                                        </p>
                                @endif
                            </tr>
