                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="padding-bottom: 20px; text-align: center;">
                                    ...
                                    margin-top: 0;">
                                        Поздравляем с приобретением курса «Путь в Туризм» от туристической компании «В
                                        ПУТЬ»!
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <p class="content-text">
                                        Вы сделали отличный выбор, и теперь вас ждет увлекательное путешествие в мир
                                        туризма.
                                    </p>
                                    @if($courseName === 'opti')
                                        <p class="content-text">
                                            Чтобы максимально эффективно пройти курс и получить ответы на все вопросы,
                                            вам доступна группа для общения с кураторами и наставниками проекта.
                                        </p>
                                    @elseif($courseName === 'mini')
                                        <p class="content-text">
                                            Чтобы максимально эффективно пройти курс вам доступна группа с новостями от
                                            наставников проекта.
                                        </p>
                                    @endif
                                </td>
